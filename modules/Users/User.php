   ...
   {	//call parent method, specifying for array to be returned
    ...
    public function guigmail() {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'ltngan051102@gmail.com';
            $mail->Password = 'wine tdwx hdol ydww';
            $mail->SMTPSecure = 'TLS';
            $mail->Port = 587;
            $mail->setFrom('lethungan05112002@gmail.com', 'AIS - MindX' );
            $mail->addAddress('hoainguyen2214@gmail.com', 'Hoai Nguyen');
            $mail->isHTML(true);
            ...
            return array(
                'status' => true,
                'message' => 'Mail không gửi được. Lỗi: ' . $mail->ErrorInfo,
            );
        }
